    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (sucursales.Contains(null))
            {
                ...
                sucursales[numsucursal-1] = new Sucursal(Input.Decimal("Ingrese el monto total"), Input.Int("Ingrese la cantidad de empleados"), Input.Int("Ingrese la cantidad de "));
            }
